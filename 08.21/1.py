...
class Tetra:
    def __init__(self,  x: int, y: int, edge: int = 10,) -> int:
        self.edge = edge
        self.x = x
        self.y = y
...
print(f'Объём первого тэтраэдра: {tetra1.volume()}')
print(f'Объём второго тэтраэдра: {tetra2.volume()}')
